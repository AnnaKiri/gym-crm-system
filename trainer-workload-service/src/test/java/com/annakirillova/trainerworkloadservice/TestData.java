...
public class TestData {
    ...
    public static final TrainerSummary.Summary SUMMARY_1 = new TrainerSummary.Summary(2024, 1, 60); // TRAINER_4
    public static final TrainerSummary.Summary SUMMARY_2 = new TrainerSummary.Summary(2024, 2, 60); // TRAINER_4
    public static final TrainerSummary.Summary SUMMARY_3 = new TrainerSummary.Summary(2024, 1, 120); // TRAINER_2
    public static final TrainerSummary.Summary SUMMARY_4 = new TrainerSummary.Summary(2024, 2, 60); // TRAINER_2
    public static final TrainerSummary.Summary SUMMARY_5 = new TrainerSummary.Summary(2024, 1, 120); // TRAINER_3
    public static final TrainerSummary.Summary SUMMARY_6 = new TrainerSummary.Summary(2024, 1, 60); // TRAINER_1
    public static final TrainerSummary.Summary SUMMARY_7 = new TrainerSummary.Summary(2024, 2, 60); // TRAINER_1

    public static final List<TrainerSummary.Summary> SUMMARY_LIST_FOR_TRAINER_1 = List.of(SUMMARY_6, SUMMARY_7);
    public static final List<TrainerSummary.Summary> SUMMARY_LIST_FOR_TRAINER_2 = List.of(SUMMARY_3, SUMMARY_4);
